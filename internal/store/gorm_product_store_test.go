...
func TestGormProductStore_Delete(t *testing.T) {
	testProduct := newTestProduct()
...
func TestGormProductStore_FindAll(t *testing.T) {
	tests := []struct {
		name     string
		products []data.Product
	}{
...
func TestGormProductStore_FindById(t *testing.T) {
	testProduct := newTestProduct()
...
func TestGormProductStore_Update(t *testing.T) {
	testProduct := newTestProduct()
	tests := []struct {
		name          string
